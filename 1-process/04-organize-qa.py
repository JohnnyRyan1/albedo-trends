...
Export AWS albedo data for QA filtered data.
...
# Define albedo data
mcd = xr.open_dataset(path2 + 'satellite/mcd43a3-summer-albedo-qa.nc')
vnp = xr.open_dataset(path2 + 'satellite/vnp43ma3-summer-albedo-qa.nc')
vji = xr.open_dataset(path2 + 'satellite/vj143ma3-summer-albedo-qa.nc')
...
for i in range(len(aws_meta)):
    ...
    # Export
    df.to_csv(path2 + 'station_qa/' + name + '.csv')
